...
####    the pair-wise reciprocal blastn searches of     ####
...
f = selectedSpeciesPairs[, sp1 == "Ambystoma_mexicanum" |
                           sp2 == "Ambystoma_mexicanum"]		#these pairs will constitute a dedicated batch (Ambystoma_mexicanum has much more TEs than the others)
...
system(
  'sbatch --mail-type=BEGIN,END,FAIL --cpus-per-task=20 --mem=60G --wrap="Rscript pairwiseSpeciesBlastn.R 1 20"'
